...
- [x] **CLEAN-01**: Remove `src/embeddings/` directory (pipeline.ts, generate.ts, text.ts)
- [x] **CLEAN-02**: Remove sqlite-vec extension loading (src/db/vec.ts) and vec0 migration (V8)
