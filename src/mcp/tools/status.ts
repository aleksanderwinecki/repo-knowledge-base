  ...
  server.tool(
    ...
    wrapToolHandler('kb_status', () => {
      ...
      return formatSingleResponse(
        ...
        `KB: ${counts.repos} repos, ${counts.modules} modules, ${counts.events} events, ${counts.learned_facts} facts | ${staleCount} stale, ${missingCount} missing (${checkedOf})`,
      );
    }),
  );
}
